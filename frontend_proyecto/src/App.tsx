...
import PruebaFuncionalidad from "./components/informeCatedra/informesCatedraCompletados/funcionalidad/PruebaFuncionalidad";
        ...
        <div className="container">
          ...
          */}
          <Routes>
            ...
            <Route path="/informes-catedra-funcion" element={<PruebaFuncionalidad />} />          
          </Routes>
        </div>
      </main>
