    ...
    <div className="card glass-card overflow-hidden border-0" style={{ width: '100%', maxWidth: '950px' }}>
      <div className="row g-0">
        ...
        <div className={`col-md-5 d-none d-md-flex flex-column justify-content-between p-5 info-panel`}>
            ...
            <div className="mb-4">
              ...
              >
                <img
                  ...
                  className="app-logo-card cursor-pointer"
          ...
          <div className="mt-4">
            <p className={`small fw-bold mb-2 text-uppercase ls-1 ${isDarkMode ? 'opacity-50' : 'text-muted opacity-75'}`}>
              Síguenos
            </p>
            ...
            <div className={`d-flex gap-3 ${isDarkMode ? 'opacity-75' : 'text-secondary'}`}>
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/share/17ZDcTxnP5/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-decoration-none text-reset"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook cursor-pointer" viewBox="0 0 16 16">
              ...
              {/* Twitter/X */}
              <a
                href="https://x.com/unpsjb_oficial?t=Ra4e4kgt_s38g6cSecEy8g&s=08"
                target="_blank"
                rel="noopener noreferrer"
                className="text-decoration-none text-reset"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x cursor-pointer" viewBox="0 0 16 16">
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/unpsjb_oficial?igsh=MWFobjNlemI3NjJ2Ng=="
                target="_blank"
                rel="noopener noreferrer"
                className="text-decoration-none text-reset"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram cursor-pointer" viewBox="0 0 16 16">
