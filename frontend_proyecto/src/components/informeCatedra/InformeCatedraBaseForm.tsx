...
export default function InformeCatedraBaseForm() {
        ...
        try {
            ...
            for (const categoriaTemp of categorias) {
                ...
                if (!resCat.ok) { 
                    ...
                    throw new Error(errorData.detail || `Error al crear categoría ${categoriaTemp.cod}.`); 
                }
            ...
            const messageToShow = error instanceof Error ? error.message : "Error desconocido.";
    ...
    const cardHeaderStyle = { backgroundColor: 'var(--color-unpsjb-blue)', color: 'white' };
