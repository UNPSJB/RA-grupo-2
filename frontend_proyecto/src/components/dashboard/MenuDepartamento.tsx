    ...
    <div className="card-modern h-100 p-4 d-flex flex-column animate-fade-up position-relative overflow-hidden">
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%' }}>
        <div className="mb-4 text-start">
          <h5 className="fw-bold mb-1 text-dark">Informes Sintéticos</h5>
        ...
        <div className="d-flex flex-column gap-5">
            ...
            <div className="animate-fade-up">
                <div className="d-flex align-items-center gap-3 mb-4">
                    ...
                    <span className="text-muted small fw-bold text-uppercase tracking-wider">Estadísticas del Departamento</span>
                    <hr className="flex-grow-1 text-secondary opacity-25" />
                </div>
