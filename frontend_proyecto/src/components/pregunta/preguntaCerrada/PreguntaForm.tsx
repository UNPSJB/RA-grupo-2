...
export default function PreguntaForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!enunciado.trim() || opcionSeleccionadas.length === 0) {
      alert("Debe ingresar un enunciado y seleccionar al menos una opción.");
      return;
    }
  ...
  return (
    <>
        {mensajeExito && <MensajeExito mensaje={mensajeExito} onClose={() => setMensajeExito(null)} />}
